=== NBA Basketball Team Stats Lite ===
Contributors: bpmee31
Donate link: http://www.ibet.ws/get_stats.php
Tags: basketball, ncaa basketball, nba, basketball stats, ncaab, nba basketball stats, nba news, sports stats, stats basketball
Requires at least: 2.2.0
Tested up to: 3.0.1
Stable tag: 0.8.2

NBA Team Stats allows bloggers display an NBA team's standings within their sidebar.

== Description ==

NBA Team Stats plugin can be added to any blog with a dynamic sidebar. Once installed, the blogger can choose their favorite NBA Team. The stats are updated each week of the NBA regular season, so that blog 
visitors can keep track of all the important NBA team standings and stats. Additionally, teams qualifying for post-season play are denoted automatically in each stats table with the the standard NBA *, x,y or z symbols.
...
1. Upload `nba-team-stats` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. The Plugin will automatically install a new option entry in your wp.options database table.
4. Go to your Design section and select the NBA Stats widget.
...
= Why is there so much "inline" CSS displayed in my NBA Stats table? =
